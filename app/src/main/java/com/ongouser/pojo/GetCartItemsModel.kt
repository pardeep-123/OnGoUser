...
data class GetCartItemsModel(
	...
	val body: GetCartItemsBody? = null
)

data class GetCartItemsBody(

	@field:SerializedName("cartItems")
	val cartItems: ArrayList<CartItemsItem?>? = null,

	@field:SerializedName("taxDetails")
val taxDetails: TaxDetail? = null
)
...
data class TaxDetail(
	...
	@field:SerializedName("siteComission")
	val siteComission: String? = null
)
...
data class CartItemsItem(
	...
	val product: GetCartProducts? = null,
